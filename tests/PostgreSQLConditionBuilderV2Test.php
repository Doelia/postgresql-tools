...
use SWouters\PostgreSQLTools\PostgreSQLConditionBuilderV2;

class PostgreSQLConditionBuilderV2Test extends TestCase
{

    public function testBuildCondition()
    {
        $builder = new PostgreSQLConditionBuilderV2();
